---
title: "Pi-hole Setup and Configuration Guide"
description: "Complete guide to deploying Pi-hole in Docker for network-wide ad blocking - covering static IP setup, Docker Compose, blocklists, and client configuration."
date: 2025-12-19
tags: ["Docker", "Pi-hole", "Networking", "Self-Hosting", "Raspberry Pi", "DNS"]
relatedProject: "/pihole"
draft: false
---

**Author:** Chicken Little - Win  
...
To simplify the setup and management of Pi-hole, the following scripts are included. Click to download:

| Script | Description |
|--------|-------------|
| [get-docker.sh](/projects/PiHole/scripts/get-docker.sh) | Automates the installation of Docker |
| [docker-compose.yml](/projects/PiHole/scripts/docker-compose.yml) | Deploying Pi-hole using Docker Compose |
| [network-config.yaml](/projects/PiHole/scripts/network-config.yaml) | Example Netplan configuration for static IP address |
| [docker-bash.sh](/projects/PiHole/scripts/docker-bash.sh) | Automates the addition of blocklists in bulk using sqlite3 |
